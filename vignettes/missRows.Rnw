...
MI was proposed by Rubin (1987) \cite{Rubin_2004} 
...
%============================================================================
 Multiple  hot-deck  imputation  proceeds  as  follows.  Let
K
= [
K
1
...
K
J
] be the merged data table containing missing rows with strata
s
= 1
,...,S
